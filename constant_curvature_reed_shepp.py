...
def calc_optimal_path(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=STEP_SIZE):
    """
    Funkcja do obliczenia ścieżki z minimalną długością
    """
...
def calc_all_paths(sx, sy, syaw, gx, gy, gyaw, maxc, step_size=STEP_SIZE):
    """
    Policz wszystkie możliwe ścieżki od [sx,sy,syaw] do [gx,gy,gyaw]

    """
    q0 = [sx, sy, syaw] # startowa konfiguracja
    q1 = [gx, gy, gyaw] # końcowa konfiguracja
    paths = generate_path(q0, q1, maxc) # ta funkcja liczy wszystkie możliwe 
